...
namespace SeekMatch.Infrastructure.Migrations
{
    ...
    [Migration("20260509034628_RemoveRejectionReasonFromJobApplicationTable")]
    partial class RemoveRejectionReasonFromJobApplicationTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeekMatch.Core.Entities.JobApplicationStep", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SeekMatch.Core.Entities.Recruiter", b =>
                {
                    ...
                    b.Property<bool>("CanDeleteJobOffers")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("SeekMatch.Core.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SeekMatch.Core.Entities.ExpressApplication", b =>
                {
                    b.HasOne("SeekMatch.Core.Entities.JobApplication", "JobApplication")
                        .WithOne("ExpressApplication")
                        .HasForeignKey("SeekMatch.Core.Entities.ExpressApplication", "JobApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SeekMatch.Core.Entities.JobApplication", b =>
                {
                    b.Navigation("ExpressApplication");

                    b.Navigation("JobApplicationSteps");
                });
